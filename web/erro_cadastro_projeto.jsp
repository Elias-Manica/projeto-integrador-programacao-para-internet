...
<html>
    <head>
        ...
        <title>Erro no Cadastro de Projeto</title>
    ...
    <body>
        <div class="container mt-5">
            <div class="alert alert-danger text-center" role="alert">
                <h4 class="alert-heading">Erro ao Cadastrar o Projeto</h4>
                <p>Ocorreu um problema durante o cadastro do projeto. Por favor, verifique os dados e tente novamente.</p>
                <hr>
                <p class="mb-0">Caso o problema persista, verifique seu banco de dados.</p>
            </div>
            <div class="text-center mt-4">
                <a href="cadastro_projetos.jsp" class="btn btn-primary">Voltar ao Cadastro de Projetos</a>
            </div>
        </div>
